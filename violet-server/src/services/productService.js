...
async function findAll() {
  ...
  const withFlashRankingMeta = attachFlashCategoryRankingMeta(withGlobalRankingMeta, metricRows);
  return sortProductsBySectionRanking(withFlashRankingMeta, metricRows);
}

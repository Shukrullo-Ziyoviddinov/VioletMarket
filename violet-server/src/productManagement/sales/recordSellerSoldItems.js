...
/**
 * BACKFILL / HEAL only — SellerSoldItem unit sync.
 * Live topshirish: recordSalesOnDelivery (assignment bo‘yicha).
 * Faqat units[].trackingStatus === "delivered" yoziladi.
 * Display metrics (flash/ranking) chaqirilmaydi.
 */

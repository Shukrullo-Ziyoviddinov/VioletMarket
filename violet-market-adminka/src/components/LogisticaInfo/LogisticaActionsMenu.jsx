...
function LogisticaActionsDropdown({ style, deleting, onDelete }) {
  return (
...
export default function LogisticaActionsMenu({
  isOpen = false,
  deleting = false,
  onToggle,
  onClose,
  ...
  useEffect(() => {
    ...
    const handlePointerDown = (event) => {
      ...
      if (target instanceof Element && target.closest('.product-card-menu__dropdown')) {
        return;
      }
      onClose?.();
    };
